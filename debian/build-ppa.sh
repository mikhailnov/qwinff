#!/usr/bin/env bash
# I use this script to build and publish deb packages in ppa:mikhailnov/qwinff (https://launchpad.net/~mikhailnov/+archive/ubuntu/qwinff)
...
do
	...
	# change PPA names to yours, you may leave only one PPA; I upload qwinff to 2 different PPAs at the same time
	for ppa_name in ppa:mikhailnov/qwinff ppa:mikhailnov/utils
	do
